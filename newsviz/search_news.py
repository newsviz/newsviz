...
class SearchWrapper:
    ...
    def get_nearest_news(self, query, top_n):
        ...
        nearest_news_ids = ranker.get_nearest(query_vec, top_n)
        return ranker.get_attributes(nearest_news_ids)


def get_nearest_news(query, top_n):
    search = SearchWrapper()
    nearest_news = search.get_nearest_news(query, top_n)
    print(nearest_news)
    return nearest_news
